...
int main (){
    ...
    float area01, pib01;
    float densidadePopulacional01, pibPerCapita01, densidadePopulacional02, pibPerCapita02;
    ...
    densidadePopulacional02 = (float)populacao01 / area02;
    ...
    printf("A Densidade demográfica é: %fpor Km\n", densidadePopulacional01);
    printf("O PIB Per Capita é: %f", pibPerCapita01);
    ...
    printf("O PIB Per Capita é: %f", pibPerCapita02);
